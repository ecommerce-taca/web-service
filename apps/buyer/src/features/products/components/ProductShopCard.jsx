  ...
  return (
    <div className="bg-white p-4 border border-border flex items-center justify-between">
      <div className="flex items-center gap-4">
        {/* Avatar Placeholder */}
        <div className="w-[60px] h-[60px] bg-surface flex items-center justify-center text-[20px] font-bold text-primary">
          {shop.avatar || 'TA'}
        </div>
        
        {/* Shop Info */}
        <div className="flex flex-col">
          <span className="text-[16px] font-bold text-main">{shop.name}</span>
